import { Engine, Scene, SceneLoader, ArcRotateCamera, HemisphericLight, MeshBuilder, Mesh, Vector3, Vector4 } from "@babylonjs/core";
...
export class Game {
    ...
    public constructor() {
        ...
        // this.box.position = new Vector3(0, 5, 10);
